...
export const userMonitor = new Queue("UserMonitor", connection, bullOpts);

export const queueMonitor = new Queue("QueueMonitor", connection, bullOpts);

export const scheduleMonitor = new Queue("ScheduleMonitor", connection, bullOpts);
...
export const schedulesRecorrenci = new Queue("schedulesRecorrenci", connection, bullOpts)
...
export const campaignQueue = new Queue("CampaignQueue", connection, bullOpts);
