...
import SendInstagramMessageService from "../services/InstagramServices/SendInstagramMessageService";
...
export const store = async (req: Request, res: Response): Promise<Response> => {
  ...
  if (ticket.channel === "instagram") {
    const recipientId = ticket.contact.instagramId || ticket.contact.number;
