...
const QueueIntegration = ({ open, onClose, integrationId }) => {
  ...
  useEffect(() => {
    (async () => {
      try {
        const { data: flowsData } = await api.get("/flows");
        if (Array.isArray(flowsData)) {
          setFlows(flowsData);
        } else if (flowsData && Array.isArray(flowsData.flows)) {
                    ...
                    <Grid item xs={12} md={6} xl={6}>
                      ...
                      >
                        ...
                        >
                          ...
                          <MenuItem value="flowbuilder">FlowBuilder (Nativo)</MenuItem>
                        </Field>
                      </FormControl>
                    </Grid>
                      ...
                      <>
                        ...
                        <Grid item xs={12} md={6} xl={6}>
                          <FormControl
                            ...
                            fullWidth
                          >
                            <InputLabel id="flow-selection-label">
                              Selecione o Fluxo
                            </InputLabel>
                            <Field
                              as={Select}
