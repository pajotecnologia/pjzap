                    ...
                    <Card className={classes.connectionCard}>
                      <Box className={classes.cardHeader}>
                        <Box display="flex" alignItems="center" minWidth={0}>
                          <Avatar className={classes.avatar} style={whatsApp.channel === "instagram" ? { backgroundColor: "#e1306c", color: "white" } : {}}>
                            {whatsApp.channel === "instagram" ? <Instagram /> : whatsApp.name.charAt(0).toUpperCase()}
                          </Avatar>
                          <Box ml={1.5} minWidth={0}>
                            ...
                            <Typography variant="caption" color="textSecondary" noWrap>
                              ID: {whatsApp.id} {whatsApp.channel === "instagram" ? "· Instagram" : "· WhatsApp"}
                            </Typography>
                          </Box>
                        </Box>
                        {whatsApp.isDefault && (
