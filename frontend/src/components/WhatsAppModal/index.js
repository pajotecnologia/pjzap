                  ...
                  <Grid spacing={2} container>
                    ...
                    <Grid item xs={12} sm={6}>
                      <FormControl variant="outlined" margin="dense" fullWidth>
                        <InputLabel id="channel-selection-label">Canal / Plataforma</InputLabel>
                        <Field
                          as={Select}
                      ...
                      <>
                        <Grid item xs={12} sm={6}>
                          <Field
                            ...
                            margin="dense"
                            fullWidth
                            placeholder="Ex: 10485720485"
                          />
                        </Grid>
                        <Grid item xs={12} sm={6}>
                          <Field
                            as={TextField}
                            label="Token de Acesso da Meta (Page Access Token)"
                    ...
                    <Grid style={{ paddingTop: 15 }} item xs={12}>
                      <FormControlLabel
                        control={
                          <Field
                            as={Switch}
