...
import FlowBuilderList from "../pages/FlowBuilder";
import FlowBuilderCanvas from "../pages/FlowBuilder/builder";
            ...
            <WhatsAppsProvider>
              <LoggedInLayout>
                ...
                <Route
                  exact
                  path="/flowbuilder"
                  component={FlowBuilderList}
                  isPrivate
                />
                <Route
                  exact
                  path="/flowbuilder/:flowId"
                  component={FlowBuilderCanvas}
                  isPrivate
                />
				<Route
                  exact
